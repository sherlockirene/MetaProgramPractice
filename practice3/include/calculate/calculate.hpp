...
#include "detail/calculate_detail.hpp"
...
namespace Model
{
    namespace Core
    {
        ...
        void Calculate(const DataType &p1, const DataType &p2, const DataType &p3, DataType &result, const DataType &target)
        {
            Core::detail::caclulate_imp_varible<T>(p1, p2, p3, result, target);
        }
    }
}
