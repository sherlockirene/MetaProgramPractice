...
{
    Plane result_plane;
    auto rv = Calculate<CalcByTime>(planes_max[0], planes_max[1], planes_max[3], result_plane, target_plane);
...
{
    Plane result_plane;
    auto rv = Calculate<CalcByPosX>(planes_max[0], planes_max[1], planes_max[3], result_plane, target_plane);
    BOOST_CHECK_EQUAL(rv, SUCCESS);
    BOOST_CHECK_LT(fabs(result_plane.time - 5), TEST_DB_EQUAL);
